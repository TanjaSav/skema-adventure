  ...
  useEffect(() => {
    ...
    async function startScanner() {
      try {
        ...
        const scanner = new Html5Qrcode("qr-reader-location-6") as QrScanner;
        ...
        <div className="flex w-full justify-center">
          <div className="flex w-full max-w-[360px] flex-col items-center">
            ...
            <div className="relative h-[370px] w-[330px] overflow-visible">
              ...
              <Image
                src="/img/location6.svg"
                alt="Location 6"
                width={28}
                height={28}
                priority
                className="absolute left-[44%] top-[49%] h-8 w-8 location-pulse"
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex w-full justify-center">
          <div className="flex w-full max-w-[360px] flex-col items-start">
            ...
            <button
              type="button"
              onClick={() => {
                localStorage.setItem("team_current_step", "6");
                setErrorMessage("");
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-[380px] rounded-2xl bg-[#FEFAEE] p-5 text-center shadow-xl">
            ...
            <div className="mt-5 overflow-hidden rounded-xl border-2 border-[#123F35] bg-white p-2">
              <div id="qr-reader-location-6" className="h-[300px] w-full" />
            </div>
