...
export default function LocationFiveMapPage() {
  ...
  useEffect(() => {
    ...
    async function startScanner() {
      try {
        ...
        const scanner = new Html5Qrcode("qr-reader-location-5") as QrScanner;
        ...
        <div className="flex w-full justify-center">
          <div className="flex w-full max-w-[360px] flex-col items-center md:items-start">
            ...
            <button
              type="button"
              onClick={() => {
                localStorage.setItem("team_current_step", "5");
                setErrorMessage("");
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-[380px] rounded-2xl bg-[#FEFAEE] p-5 text-center shadow-xl">
            ...
            <div className="mt-5 overflow-hidden rounded-xl border-2 border-[#123F35] bg-white p-2">
              <div id="qr-reader-location-5" className="h-[300px] w-full" />
            </div>
